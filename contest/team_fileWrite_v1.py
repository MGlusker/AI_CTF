...
class BaseCaptureAgent(CaptureAgent):
  ...
  minimaxTimeFileName = str(("Depth", DEPTH, "particleTimeFile.txt"))

  particleTimeFile = open("particleTimeFile.txt","a")
  minimaxTimeFile = open(minimaxTimeFileName, "a"  )
  totalTimeFile= open("totalTimeFile.txt","a")
  ...
  def chooseAction(self, gameState):
    ...
    print "Particle Filtering time:", time.time() - self.start
    self.particleTimeFile.write(str((time.time() - start, " ")))
    ##########################
    # END PARTICLE FILTERING #
    ##########################
    ...
    self.minimaxTimeFile.write(str((time.time() - minimaxStart, " ")))
    ...
    self.totalTimeFile.write(str((time.time() - start, " ")))
