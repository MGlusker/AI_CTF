...
class JointParticleFilter:
  ...
  def setParticlesToJailTimer(self, gameState, opponentAgentIndex, currentAgentIndex):
    ...
    if (currentAgentIndex == opponentAgentIndex+1) or (currentAgentIndex == 0 and opponentAgentIndex == 3):
    ...
    print "              Jail Timer: ", self.jailTimer[opponentAgentIndex], " opponentAgentIndex:" , opponentAgentIndex
